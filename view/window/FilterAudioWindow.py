...
class FilterAudioWindow(QDialog):
    ...
    def initialize_window_elements(self):
        ...
        self.filter_list_widget.itemSelectionChanged.connect(
    ...
    def display_filter_properties(self):
        ...
        if selected_item:
            ...
            self.filter_name_label.setText(
                f"Filter Name: {properties.get('filter_name', '')}"
            )
            self.filter_type_label.setText(
                f"Filter Type: {properties.get('filter_type', '')}"
            )
            self.filter_cutoff_frequency_label.setText(
